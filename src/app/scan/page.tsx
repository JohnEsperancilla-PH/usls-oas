    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm w-full max-w-sm">
          ...
          <h1 className="text-lg font-bold text-gray-900 text-center">Gate QR Scanner Login</h1>
          ...
          <p className="text-center text-xs text-gray-400 mt-4">
            Prefer typing?{" "}
            <Link href="/entry" className="text-primary hover:underline">Use the reference entry screen</Link>
          </p>
        </div>
      </div>
    );
            ...
            <div className="grid gap-4 lg:min-h-[calc(100vh-12rem)] lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)] items-stretch animate-fade-in">
              ...
              <section className="bg-white rounded-xl p-5 sm:p-6 border border-primary/20 shadow-md flex min-h-[420px] flex-col">
                <div className="mb-6">
                  ...
                  <h1 className="text-xl font-bold text-gray-900 mt-1">QR Scanner</h1>
                  <p className="text-sm text-gray-500 mt-1">Point the camera at the visitor&apos;s QR code to verify entry.</p>
                </div>
